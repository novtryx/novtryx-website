...
const Footer = () => {
    ...
    return (
        <div className='bg-black px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-8 sm:py-10 md:py-12 text-[#F9F7F4]'>
            <div className='flex flex-col gap-12 sm:gap-16 md:gap-20 lg:gap-24'>
                ...
                >
                    ...
                    >
                        ...
                        <p className='text-[24px] sm:text-[28px] md:text-[30px] tracking-tighter'>NOVTRYX</p>
                    </motion.div>
                    ...
                    <div className='flex items-center gap-2 sm:gap-3 md:gap-4 flex-wrap'>
                        {
                            socialLinkArray.map((item:SocialLinkArrayType, index: number) => (
                                ...
                                >
                                    ...
                                    >
                                        <item.icon size={20} className="sm:w-5 sm:h-5 md:w-6 md:h-6" />
                                    </Link>
                                </motion.div>
                            ))
                        }
            ...
            >
                <p className='text-[#B3B3B3] text-[13px] sm:text-[14px] md:text-[15px]'>© 2026 Novtryx. All rights reserved.</p>
            </motion.div>
        </div>
    )
}
